...
- **주요 문서**: Detailed specifications are located in [`docs/`](docs/README.md)
  - [`docs/01_PRD.md`](docs/01_PRD.md)
  - [`docs/02_ARCHITECTURE.md`](docs/02_ARCHITECTURE.md)
  - [`docs/03_USER_FLOW.md`](docs/03_USER_FLOW.md)
  - [`docs/04_DATA_MODEL_AND_API.md`](docs/04_DATA_MODEL_AND_API.md)

---

## 🛠️ 2. 기술 스택 & 핵심 개발 원칙 (Tech Stack & Core Principles)
- **자세한 개발 지침**: [`android/README.md`](android/README.md)
- **필수 준수 원칙 4가지**:
...
### 📂 디렉토리 구조
- [`ai-tickets/todo/`](ai-tickets/todo): 대기 중인 작업 티켓
- [`ai-tickets/doing/`](ai-tickets/doing): 현재 진행 중인 작업 티켓
- [`ai-tickets/done/`](ai-tickets/done): 완료된 작업 티켓
